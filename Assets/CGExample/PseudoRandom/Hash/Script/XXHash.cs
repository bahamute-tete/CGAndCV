...
public readonly  struct SmallXXHash
{
    ...
    static uint RotateLeft(uint data, int step) => (data << step) | (data >> 32 - step);
    public SmallXXHash Eat(int data)=>RotateLeft(accumulator + (uint)data * primeC, 17) * primeD;
    public SmallXXHash Eat(byte data)=> RotateLeft(accumulator + (uint)data * primeE, 11) * primeA;
...
public readonly struct SmallXXHash4
{
    ...
    static uint4 RotateLeft(uint4 data, int step) => (data << step) | (data >> 32 - step);
