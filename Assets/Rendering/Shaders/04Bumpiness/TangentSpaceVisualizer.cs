...
public class TangentSpaceVisualizer : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        if (meshFilter)
        {
            ...
            if (mesh)
            {
                ShowMeshTangentSpace(mesh);
            }

        }
    }

    private void ShowMeshTangentSpace(Mesh mesh)
    {
        ...
        {
            ShowMeshTangentSpace(transform.TransformPoint(vertices[i]),
    ...
    private void ShowMeshTangentSpace(Vector3 vertex, Vector3 normal, Vector3 tangent, float binormalSign)
    {
