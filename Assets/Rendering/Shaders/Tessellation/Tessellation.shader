Shader "Custom/Tesselation" {
	...
	Properties {
		...
		// _TessellationEdgeLength_W("_Tessellation Edge Length (World)",Range(0.1,1))=0.5
		// // use pixels
		// _TessellationEdgeLength_S("_Tessellation Edge Length (Screen)",Range(5,100))=50
...
//	#define PARALLAX_RAYMARCHING_SEARCH_STEPS 3
	...
	SubShader {
		...
		Pass {
			...
			//#define _TESSELLATION_EDGE_W
			//#define _TESSELLATION_EDGE_S
			//#define _TESSELLATION_EDGE_VIEW
